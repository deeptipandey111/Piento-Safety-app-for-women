...
let HRToastManualPosition   =   "manaual"
...
let HRToastFontSize       :  CGFloat  = 17.0
let HRToastMaxTitleLines              = 0
let HRToastMaxMessageLines            = 0

// shadow appearance
let HRToastShadowOpacity  : CGFloat   = 0.6
let HRToastShadowRadius   : CGFloat   = 5.0
...
extension UIView {
    ...
    */
    ...
    class func hr_toastThemeColor() -> UIColor {
        ...
        if color == nil {
            color = UIColor(red: 33/255.0, green: 33/255.0, blue: 33/255.0, alpha: 0.7)
    ...
    class func hr_toastTitleFontName() -> String {
        ...
        if name == nil {
            ...
            let font = UIFont.init(name: "SFUIDisplay-Regular", size: 17)!
            name = font.fontName
    ...
    */
    ...
    fileprivate func centerPointForPosition(_ position: AnyObject, toast: UIView) -> CGPoint {
        if position is String {
            ...
            } else if position.lowercased == HRToastManualPosition {
                return CGPoint(x: viewSize.width/2, y: viewSize.height - toastSize.height/2 - 80)
            }
